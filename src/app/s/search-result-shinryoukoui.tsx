...
export default function SearchResultShinryoukoui() {
  ...
  const filterExpression = useMemo(() => {
    const r = parseQuery(query, MASTER_IDS.SHINRYOUKOUI);
    if (r.kind === "ERROR") {
      return r;
    }
    return normalizeFilterExpression(r.value, MASTER_IDS.SHINRYOUKOUI);
  }, [query]);
